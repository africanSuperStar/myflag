<template>
  <ul class="grid">
    <li>
      <a href="#">
        <img src="@/assets/carousel/leaf-1.png" alt="" />
        <span class="description">Dearest Diary</span>
      </a>
    </li>
    <li>
      <a href="#">
        <img src="@/assets/carousel/leaf-5.jpeg" alt="" />
      </a>
      <span class="description">Window Sill?</span>
    </li>
    <li>
      <a href="#">
        <img src="@/assets/carousel/leaf-3.png" alt="" />
        <span class="description">Listen To Me</span>
      </a>
    </li>
    <li>
      <a href="#">
        <img src="@/assets/carousel/leaf-4.png" alt="" />
        <span class="description">Travel Often</span>
      </a>
    </li>
    <li>
      <a href="#">
        <img src="@/assets/carousel/coin-soil.jpeg" alt="" />
        <span class="description">Another Plant?</span>
      </a>
    </li>
    <li>
      <a href="#">
        <img src="@/assets/carousel/leaf-2.png" alt="" />
        <span class="description">On the Wave</span>
      </a>
    </li>
    <li>
      <a href="#">
        <img src="@/assets/carousel/leaf-6.jpg" alt="" />
        <span class="description">Great Gatsby</span>
      </a>
    </li>
    <li>
      <a href="#">
        <img src="@/assets/carousel/leaf-7.jpeg" alt="" />
